function [ss, err_vec, err_id, err_labels, err_legends] = loglike_reparam(theta_sn, data, pars, mcmcpars, model, lambda, theta_start, theta_std)
...
% this was wrong! so v18 result was wrong -- to be corrected
% theta = (theta + theta_start).*theta_std;

theta = theta_start + theta_sn.*theta_std;
